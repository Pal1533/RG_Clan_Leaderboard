...
1. [GitHub private vulnerability reporting](https://github.com/wiljdaws/RG_Clan_Leaderboard/security/advisories/new)
...
a public proof-of-concept or steps that let someone else change Clash
standings or clan admin data.
...
The Clash board reads live clan and event docs. Admin Google accounts can
edit event settings. Please do not treat a missing paid-tier Firebase control
as a vulnerability unless it lets a stranger write another clan, inject
